...
\begin{enumerate}
    ...
    \item $\mathbb{R}$ declares the real numbers. $\mathbb{N}$ denotes the natural numbers. It is of course the case that $\mathbb{N} \subseteq \mathbb{R}$.
\end{enumerate}
